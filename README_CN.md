...
| **[script-to-video-seedance](skills/script-to-video-seedance/SKILL.md)** | 动作片、MV、真实运动与物理、多模态参考(≤9 张图 + ≤3 视频 + ≤3 音频)、音素级 lip-sync、中文原生 prompt。用 Seedance 2.0 Fast + `@图片N` 位置引用。默认 480p 省成本。 |
